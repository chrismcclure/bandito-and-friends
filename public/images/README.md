...
Drop image assets here. Files in `public/` are served at the site root (e.g. `/images/...`).
...
See `art/references/title-artwork.md` for change details.
